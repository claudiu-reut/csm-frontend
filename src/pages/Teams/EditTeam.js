...
function EditTeam() {
  ...
  const getTeam= async () => {
    try {
      ...
      const result = await axios.get(`/getteam/${params.id}`);
      const img = await axios.get(`/getteamlogo/${params.id}`)
        ...
        axios({
            ...
            .then(function (response) {
                if (response.data.status !== 'ERROR') {
                    setIcon(iconSucces)
                    setMessage('Echipa editata cu succes')
                    setTextColor('black')
                  } 
    ...
    <div className='Auth-form-container'>
      <form className='Auth-form'>
        <div className='Auth-form-content'>
          <h3 className='Auth-form-title'>Editeaza Echipa <i>{nume}</i></h3>
          ...
          <div className='form-group mt-3'>
            ...
            <label>Țara</label>
            <select class="form-select" onChange={(e) => setTara(e.target.value)} value={tara}>
            <option value="0" label="Selecteaza țara... " selected disabled>Selecteaza țara...  </option>
